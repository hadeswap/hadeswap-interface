...
import { ChainId, Currency, ETHER, Percent, WETH, currencyEquals } from 'hadeswap-beta-sdk'
            ...
            <>
                <RowBetween>
                    <Text color={theme.text2} fontWeight={500} fontSize={16}>
                        {i18n._(t`SOUL ${currencyA?.getSymbol(chainId)}/${currencyB?.getSymbol(chainId)} Burned`)}
                    </Text>
                    <RowFixed>
