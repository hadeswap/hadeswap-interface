...
import SoulImage from '../../assets/images/sushi.png'
import XSoulImage from '../../assets/images/xsushi.png'
            ...
            <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                    ...
                    <div className="flex items-center">
                        <img className="w-10 md:w-16 -ml-1 mr-1 md:mr-2 -mb-1.5" src={XSoulImage} alt="soul" />
                        <div className="flex flex-col justify-center">
                            <p className="text-caption2 md:text-lg font-bold text-high-emphesis">
                                {formatFromBalance(xSoulBalance.value)}
                            </p>
                            <p className="text-caption2 md:text-caption text-primary">xSOUL</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col flex-grow">
                    ...
                    <div className="flex items-center ml-8 md:ml-0">
                        <img className="w-10 md:w-16 -ml-1 mr-1 md:mr-2 -mb-1.5" src={SoulImage} alt="soul" />
                        <div className="flex flex-col justify-center">
                            <p className="text-caption2 md:text-lg font-bold text-high-emphesis">
                                {formatFromBalance(soulBalance.value)}
                                {/* {soulEarnings.toPrecision(7)} */}
                            </p>
                            <p className="text-caption2 md:text-caption text-primary">SOUL</p>
                        </div>
                    </div>
                </div>
