...
const tips: readonly Tip[] = [
    {
        ...
        image: BentoSquare,
        description:
            'Deposit your xSOUL into BentoBox to passively earn yield through an xSOUL investment strategy, or use as collateral within Kashi and future Bento dapps.',
        href: '#'
    },
    {
        ...
        image: Vote,
        description:
            'As an xSOUL holder, your share of the staking pool correlates to the weight of your vote when participating in on-chain governance.',
        href: '#'
    },
    {
        ...
        image: AaveSquare,
        description:
            'Deposit your xSOUL into Aave to receive aXSOUL to earn collateral interest and borrowing power.',
        href: '#'
    },
    {
        ...
        description: (
            <>
                ...
                by depositing xSOUL or by staking your SOUL LP tokens from the{' '}
                <Link to="#" className="underline">
                    SOUL/xSOUL
                </Link>{' '}
                and/or{' '}
...
export default function SoulBarTips() {
    ...
    return (
        <>
            ...
            <div className="w-full max-w-2xl mb-4">
                ...
                <div className="text-high-emphesis text-h4">Make the most of your xSOUL.</div>
                <div className="text-gray-500 py-3">
                    You can leave the bar and exchange your xSOUL for SOUL (as well as collect any earned interest) at
                    any time. However, there are more ways to use xSOUL to maximize your yield potential!
                </div>
