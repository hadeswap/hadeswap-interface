...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from 'hadeswap-beta-sdk'
...
export default function AddLiquidity({
    ...
    async function onAdd() {
        ...
        if (currencyA === ETHER || currencyB === ETHER) {
            ...
            console.log(wrappedCurrency(tokenBIsETH ? currencyA : currencyB, chainId)?.address ?? '', // token
    ...
    return (
        <>
            ...
            <div className="bg-dark-900 w-full max-w-2xl rounded z-10 shadow-blue-glow">
