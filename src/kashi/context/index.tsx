import { ChainId, Currency, WETH } from 'hadeswap-beta-sdk'
...
import { bentobox } from 'hadeswap-beta-data'
...
//
//     useEffect(() => {
//         if (account && chainId && [ChainId.MAINNET, ChainId.BSC, ChainId.MATIC].indexOf(chainId) != -1) {
//             updatePairs()
//         }
