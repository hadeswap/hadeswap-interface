import { JSBI, Pair, Percent, TokenAmount } from 'hadeswap-beta-sdk'
            ...
            {userPoolBalance && JSBI.greaterThan(userPoolBalance.raw, JSBI.BigInt(0)) ? (
                ...
                <div className="bg-purple rounded p-4 bg-opacity-20 w-full mt-4">
                    <p>
                        ...
                        {t`By adding liquidity you'll earn 0.3% of all trades on this pair proportional to your share
